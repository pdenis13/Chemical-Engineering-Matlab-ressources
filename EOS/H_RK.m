...
% CP_IG : Heat Capacity at constant pressure in Ideal Gas case
...
function [H_1,Two_Phase, H_2] = H_RK(T,P,TC,PC)
...
if (N_phase > 1);
    Two_Phase = true;
     ...
     H_1 = (Z_1 - 1 - 1.5*omega_a/(omega_b*Tr^1.5) * log(1 + b/V_1))*R*T;
     H_2 = (Z_2 - 1 - 1.5*omega_a/(omega_b*Tr^1.5) * log(1 + b/V_2))*R*T;
    elseif (N_phase == 1);
    Two_Phase = false;
    Z_1 = racines(idx~=0);
    Z_2 = NaN;
